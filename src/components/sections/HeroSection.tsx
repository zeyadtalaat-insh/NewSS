...
export default function HeroSection() {
  ...
  const tag = language === "en" ? "MENA's #1 AI Production Studio" : "أول استوديو ذكاء اصطناعي في المنطقة";
  const title1 = language === "en" ? "World-class" : "إنتاج عالمي";
  const title2 = language === "en" ? "production at AI speed" : "بسرعة الذكاء الاصطناعي";
  const title3 = language === "en" ? "for every brand." : "لكل براند.";
  const desc = language === "en"
    ? "Broadcast-quality commercials, brand avatars, and photoshoots — produced in days, not months. Built MENA-first, bilingual, and impossibly fast."
    : "إعلانات بجودة تلفزيونية، شخصيات براند، وجلسات تصوير — تتسلم في أيام مو شهور. مبني للمنطقة، ثنائي اللغة، وبسرعة خيالية.";
  const benefits = language === "en"
    ? ["From 1-day delivery", "EN + Saudi Arabic", "90% cost reduction", "Unlimited variations"]
    : ["تسليم من يوم واحد", "عربي + إنجليزي", "تكلفة أقل بـ 90%", "أشكال لا محدودة"];
  const cta1 = language === "en" ? "Book a discovery call" : "احجز مكالمة تعارف";
  const cta2 = language === "en" ? "See our work" : "شاهد أعمالنا";
      ...
      >
        <div style={{ textAlign: isRTL ? "right" : "left" }}>
          ...
          >
            ...
            <span style={{ display: "block" }}>{title3}</span>
          </h1>
        ...
        <div style={{ position: "relative", justifySelf: "center", width: "320px", aspectRatio: "9/16" }}>
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: "10px", color: "var(--muted)", marginTop: "3px" }}>
                {language === "en" ? "from 200+ clients" : "من 200+ عميل"}
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              {muted ? (language === "en" ? "Tap for sound" : "اضغط للصوت") : (language === "en" ? "Mute" : "كتم")}
            </button>
          </div>
